...
int main(int argc, char **argv) {
    ...
    std::string centroid_file = preprocess_file + "_centroids";
    ...
    search_param.hash_reset_interval = calculate_hash_reset_interval(search_param.beam, degree,
    ...
    index.search(search_param, d_query.view(), result_ids.view(), result_dists.view(), result_file);
